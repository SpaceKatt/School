...
public class TwelveBitChallengeSolution {
        
    public static void main(String[] args) {
        TwelveBitChallengeSol challenge = new TwelveBitChallengeSol();
        challenge.startChallenge();
    }
}

class TwelveBitChallengeSol {
    private int count;    
    private boolean zeroOne;
    
    /**
     * A solution to the Twelve Bits Challenge.
     * @param bits
     * @return 
     */
    public int solutionSteps(boolean[] bits) {
        ...
        int moveOne = compareValues(bits, "1,2,3,4", "5,6,7,8");
        if (moveOne == 0) {
            int returnValue = compareValues(bits, "9,10", "11,8");
            if (returnValue == 0) {
                answer = 12;
            ...
            int moveTwo = compareValues(bits, "1,5,6", "2,7,8");
            if (moveTwo == 0) {
                int threeDeep = compareValues(bits, "4", "9");
                if (threeDeep == 0) {
                    answer = 3;
                } else {
                    answer = 4;
                ...
                int moveTwoThree = compareValues(bits, "7", "8");
                if (moveTwoThree == 1) {
                    answer = 8;
                } else if (moveTwoThree == 0) {
                    answer = 1;
                } else if (moveTwoThree == 2) {
                    answer = 7;
                }
            } else if (moveTwo == 2) {
                int moveTwoFour = compareValues(bits, "5", "6");
                if (moveTwoFour == 1) {
                    answer = 6;
                } else if (moveTwoFour == 0) {
                    answer = 2;
                } else if (moveTwoFour == 2) {
                    answer = 5;
                }
            }
        } else if (moveOne == 2) {
